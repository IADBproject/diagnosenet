...
## Warning: When using Tensorflow-gpu in version 1.4.1, the module 'tensorflow.python.framework.fast\_tensor\_util' does not match with runtime Python version 3.6.
```
